...
%% (\chaptername is set to "Лекция" at the top of the document body — polyglossia
%%  installs its Bulgarian captions at \begin{document} and would overwrite a
%%  preamble \renewcommand.)
